...
# we can't get orthologs between GRCh37 and some of the other genomes since
# they're in different Ensembl releases, but we can assume that the orthologs
# of any given intron in GRCh38 are probably the same as the equivalent intron
# in GRCh37, so that's how we get GRCh37 into the ortholog clusters
srun perl GRCh37_orthologs.pl
